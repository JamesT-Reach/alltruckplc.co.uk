...
if($body_background_image){
	echo " style=\"background-color:" . $body_background_color . ";background-image:url(" . $body_background_image['url'] . ");background-repeat:no-repeat;background-position:center bottom;\"";
} 
?>>
