<div id="footer-outer-light">
	<footer>
					...
					echo "<div id=\"footer-contact-box\">";
						...
						echo "<div id=\"footer-contact-box-call\">";
							echo "<h3>Call</h3>";		
								...
								if(get_field('change_number')) {
									$footer_contact_box_telephone_number = get_field('number');
								} else {
		...
		<?php
			if(get_field('display_trust_logos')){

				$logos = get_field('trust_logos');

				if($logos) {
					echo "<div id=\"trust-logos\">";
						foreach($logos as $logo)
						{
							echo "<div><img src=\"" . $logo['image']['url'] . "\"></div>";
						}
					echo "</div>";
				}
			}
